(function () {
	...
	angular
		...
		.controller('SV.04svRecResProcListCtrl', ['$scope', '$state', '$timeout', 'SvListPageVO', 'SV.04svRecResProcListBiz', 'resData', 'Page',
			function ($scope, $state, $timeout, SvListPageVO, svRecResProcListBiz, resData, Page) {
				var page  = $scope.page = new Page({ auth: resData.access });
	
			var page_title = "서비스 결과 정보";
			var objBiz = svRecResProcListBiz;
			var strGridProcedureParam = "USP_SV_RECRESPROCSEARCH_GET&" +
			...
			var gridObj_BoxTitle = "서비스 결과 정보";
			...
			var gridObj_DetailPage = "/04svRecResProc/detail?ids=";
