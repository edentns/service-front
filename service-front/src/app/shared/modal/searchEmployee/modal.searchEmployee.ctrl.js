(function () {
	...
	angular.module( "edtApp.common.modal" )
		.controller("modal.searchEmployeeCtrl", ["$scope", "$modalInstance", "ngTableParams", "$sce", "$filter", "SY.userListSvc", "SY.codeSvc", "APP_CODE", "SY.departSvc",
			function ($scope, $modalInstance, ngTableParams, $sce, $filter, SyUserListSvc, SyCodeSvc, APP_CODE, SyDepartSvc) {
